...
public class IceClient {
	public static void main(String[] args) {
		...
		try {
			...
			ObjectPrx base1 = communicator.stringToProxy("calc/calc11:tcp -h 0.0.0.0 -p 10000 -z : udp -h 0.0.0.0 -p 10000 -z"); //opcja -z włącza możliwość kompresji wiadomości
				...
				try {
					...
					switch (line) {
						...
						case "avg":
							try {
								long[] numbers = {1, 2, 3};
								r = (long) obj1.avg(numbers);
								System.out.println("RESULT = " + r);
							} catch (EmptyListException e) {
								System.out.println("Error: Given number list is empty");
							}
