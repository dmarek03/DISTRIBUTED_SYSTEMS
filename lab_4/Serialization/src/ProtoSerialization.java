...
import sr.proto.AddressBookProtos.IncomeHistory;
...
public class ProtoSerialization {
    ...
    public void performProtoSerialization() throws IOException
    {
        ...
        IncomeHistory incomeHistory = IncomeHistory.newBuilder()
                .addIncomeAmounts(1500.75)
                .addIncomeAmounts(1600.50)
                .addIncomeAmounts(1700.25)
                .build();
